...
|
| SECURITY RECOMMENDATION: Enable this in production to prevent man-in-the-middle attacks
| Default: FALSE (for backwards compatibility and local development)
| 
| When enabled, all HTTP requests will be rejected with 426 Upgrade Required
| Users are responsible for their own security configuration.
*/
...
|
| SECURITY UPDATE: Default credentials removed for security
| Example usage (if needed): $config['rest_valid_logins'] = ['username' => 'secure_password'];
| WARNING: Do not use weak or default passwords in production!
*/
...
|
| SECURITY NOTE: The Login controller has built-in CORS handling that respects this setting.
| Default: FALSE (for backwards compatibility)
| 
| When disabled, Login controller will not send CORS headers.
| Users can enable and configure as needed for their use case.
*/
...
| source domain
|
| SECURITY UPDATE: Disabled by default for security. Set allowed_cors_origins instead.
| WARNING: Setting this to TRUE allows any website to access your API!
*/
