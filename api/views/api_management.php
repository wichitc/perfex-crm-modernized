                           ...
                           <tr>
                              ...
                              <td class="options">
                                 <div class="row-options">
                                    <a href="<?php echo admin_url('api/edit_user/' . $user['id']) ?>" 
                                       class="btn btn-default btn-icon" 
                                       data-toggle="tooltip" 
                                       data-placement="top"
                                       title="<?php echo _l('edit_user'); ?>">
                                       <i class="fa fa-pencil"></i>
                                    </a>
                                    <a href="<?php echo admin_url('api/user_stats/' . $user['id']) ?>" 
                                       class="btn btn-success btn-icon" 
                                       data-toggle="tooltip" 
                                       data-placement="top"
                                       title="<?php echo _l('user_statistics'); ?>">
                                       <i class="fa fa-bar-chart"></i>
                                    </a>
                                    <a href="<?php echo admin_url('api/delete_user/' . addslashes($user['id'])); ?>" 
                                       class="btn btn-danger btn-icon _delete" 
                                       data-toggle="tooltip" 
                                       data-placement="top"
                                       title="<?php echo _l('delete_user'); ?>">
