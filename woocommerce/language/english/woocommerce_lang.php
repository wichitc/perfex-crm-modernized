...
$lang['woocommerce_new_store']                  = 'New Store';
$lang['woocommerce_edit_store']                 = 'Edit Store';
...
// Woo order status labels. Used by the store wizard's Sync Options tab
// (auto_invoice_statuses multi-select) and any other view that does
// `_l('woocommerce_status_' . $status, $status)`. Keys mirror Woo's
// canonical statuses from its REST API.
