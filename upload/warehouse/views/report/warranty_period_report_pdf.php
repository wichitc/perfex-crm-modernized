...
foreach ($warranty_period as $key => $packing_list_detail) {
	...
	$itemHTML .= '</td>';
			 ...
			 * @var string
			 */
			if(new_strlen($packing_list_detail['commodity_name'] ?? '') == 0){
			...
			// sub total
			$itemHTML .= '<td class="amount " align="left" width="10%" '.$text_color.'>' . app_format_money((float)$packing_list_detail['unit_price'], $base_currency_id) . '</td>';
