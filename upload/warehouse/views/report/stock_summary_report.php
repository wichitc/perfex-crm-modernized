        ...
        <div class="form-group mtop25">
          <div class="btn-group">
           ...
           <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li class="hidden-xs"><a href="?output_type=I" target="_blank" onclick="stock_summary_report_export_excel(this); return false;"><?php echo _l('download_xlsx'); ?></a></li>

          </ul>
        </div>
        <a href="#" id="dowload_items"  class="btn btn-warning pull-left  mr-4 button-margin-r-b hide"><?php echo _l('download_xlsx'); ?></a>
        <a href="#" onclick="get_data_stock_summary_report(); return false;" class="btn btn-success" ><?php echo _l('_filter'); ?></a>
