				...
				<div class="panel_s">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-md-6 <?php if($pr_orders_status == false){ echo 'hide';} ;?>" >
								<div class="f_supplier_code">
									<div class="form-group select-placeholder">
										<label for="supplier_code" class="control-label"><?php echo _l('supplier_name'); ?></label>
										<select id="supplier_code" name="supplier_code" data-live-search="true" data-width="100%" class="ajax-search<?php if (isset($goods_receipt) && empty($goods_receipt->supplier_code)) {
											echo ' supplier-removed';
										} ?>" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
										<?php $selected = (isset($goods_receipt) ? $goods_receipt->supplier_code : '');
										if ($selected == '') {
											$selected = (isset($supplier_id) ? $supplier_id: '');
										}
										if ($selected != '') {
											$rel_data = get_supplier_relation_data('supplier', $selected);
											$rel_val  = get_supplier_relation_values($rel_data, 'supplier');
											echo '<option value="' . $rel_val['id'] . '" selected>' . $rel_val['name'] . '</option>';
										} ?>
									</select>
								</div>
							</div>
								<div class="hide f_supplier_name">
									<?php echo render_input('supplier_name','supplier_name', '', '',array('disabled' => 'true')) ?>
								</div>
								<div class="hide i_supplier_code">
								</div>
						</div>
							...
							<div class="col-md-12">
								<?php echo render_custom_fields('iv_receipt', isset($goods_receipt) ? $goods_receipt->id : ''); ?>
							</div>
						</div>
					</div>
