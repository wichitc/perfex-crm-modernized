      ...
      <div class="col-md-12" id="small-table">
        <div class="panel_s">
          <div class="panel-body">
            ...
            <div class="row">
              <div class=" col-md-3">
                <div class="form-group">
                  <select name="warehouse_filter[]" id="warehouse_filter" class="selectpicker" multiple="true"
                    data-live-search="true" data-width="100%"
                    data-none-selected-text="<?php echo _l('warehouse_filter'); ?>">

                    <?php foreach ($warehouse_filter as $warehouse) { ?>
                      <option value="<?php echo new_html_entity_decode($warehouse['warehouse_id']); ?>">
                        <?php echo new_html_entity_decode($warehouse['warehouse_name']); ?>
                      </option>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class=" col-md-2">
                <div class="form-group">
                  ...
                  <select name="item_filter[]" id="item_filter" class="selectpicker" multiple="true"
                    data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('tags'); ?>">

                    <?php foreach ($item_tags as $item_f) { ?>
                      <option value="<?php echo new_html_entity_decode($item_f['id']); ?>">
                        <?php echo new_html_entity_decode($item_f['name']); ?>
                      </option>
                    <?php } ?>
              ...
              <div class=" col-md-2">
                <div class="form-group">
                  <select name="alert_filter" id="alert_filter" class="selectpicker" data-live-search="true"
                    data-width="100%" data-none-selected-text="<?php echo _l('alert_filter'); ?>">
            ...
            <div class="row">
              <!-- view/manage -->
              <div class="modal bulk_actions" id="table_inventory_bulk_actions" tabindex="-1" role="dialog">
              ...
              <div class="modal export_item" id="table_inventory_export_item" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
              ...
              <div class="modal bulk_actions" id="table_inventory_print_barcode" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                      ...
                      <?php if (has_permission('warehouse_item', '', 'create') || is_admin()) { ?>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="radio radio-primary radio-inline">
                                <input onchange="print_barcode_option(this); return false" type="radio" id="y_opt_1_"
                                  name="select_item" value="0" checked>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="radio radio-primary radio-inline">
                                <input onchange="print_barcode_option(this); return false" type="radio" id="y_opt_2_"
                                  name="select_item" value="1">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="checkbox checkbox-primary">
                        ...
                        <label
                          for="filter_all_simple_variation"><?php echo _l('search_all_simple_variation_product'); ?>
                          <i class="fa fa-question-circle i_tooltip" data-toggle="tooltip" title=""
                            data-original-title="<?php echo _l('search_all_simple_variation_tooltip'); ?>"></i>
                        </label>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-md-12">
                <?php if (is_mobile()) { ?>
                  <button class="btn btn-primary" onclick="toggleScanner()">
                    <i class="fa fa-barcode"></i><?php echo _l('wh_Scan_Barcode'); ?>
                  </button>
                <?php } ?>
                <div id="scanner-wrapper" style="display:none; margin-top:15px;">
                  <div id="reader">
                  </div>
                  <div id="scan-overlay">
                  ...
                  <div class="mt-3">
                    <strong>Last code:</strong> <span id="last_code"></span>
                  </div>
              ...
              <div class="col-md-12">
                <?php
                $table_data = array(
                  '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="table_inventory"><label></label></div>',
                  _l('_images'),
                  _l('commodity_code'),
                  _l('commodity_name'),
                  _l('sku_code'),
                ...
                render_datatable(
                  ...
                  array(
                    ...
                    'id' => 'table-table_inventory',
                    'data-last-order-identifier' => 'table_inventory',
                    'data-default-order' => get_table_last_order('table_inventory'),
                  )
                ); ?>
          ...
          <div class="horizontal-tabs">
            <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
              <li role="presentation" class="active">
                <a href="#interview_infor" aria-controls="interview_infor" role="tab" data-toggle="tab"
                  aria-controls="interview_infor">
                  <span class="glyphicon glyphicon-align-justify"></span>&nbsp;<?php echo _l('general_infor'); ?>
                </a>
              </li>
              <li role="presentation">
                <a href="#interview_evaluate" aria-controls="interview_evaluate" role="tab" data-toggle="tab"
                  aria-controls="interview_evaluate">
            ...
            <div class="row">
              <div class="col-md-6">
                <a href="#" class="pull-right display-block input_method"><i
                    ...
                    data-original-title="<?php echo _l('commodity_barcode_tooltip'); ?>"></i></a>
                <?php echo render_input('commodity_barcode', 'commodity_barcode', '', 'text'); ?>
              </div>
              <div class="col-md-3">
                <a href="#" class="pull-right display-block input_method"><i
                    class="fa fa-question-circle skucode-tooltip" data-toggle="tooltip" title=""
                    data-original-title="<?php echo _l('commodity_sku_code_tooltip'); ?>"></i></a>
                ...
                <div class="form">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <div class="checkbox checkbox-primary">
                          <input type="checkbox" id="without_checking_warehouse" name="without_checking_warehouse"
                            value="without_checking_warehouse">

                          <label
                            for="without_checking_warehouse"><?php echo _l('without_checking_warehouse'); ?><small><?php echo _l('without_checking_warehouse_tooltip') ?>
                            </small>
                          </label>
                        </div>
                      </div>
            ...
            <div class="list_approve">
              <div id="item_approve">
                <div class="col-md-11">
                  ...
                  <div class="col-md-8">
                    <div class="options_wrapper">
                      ...
                      ?>
                      <span class="pull-left fa fa-question-circle" data-toggle="tooltip" title=""
                        data-original-title="<?php echo _l('wh_variation_tooltip'); ?>"></span>
                ...
                <div class="col-md-1 new_vendor_requests_button">
                  <span class="pull-bot">
                    <button name="add" class="btn new_wh_approval btn-success" data-ticket="true" type="button"><i
...
<?php init_tail(); ?>
<?php require 'modules/warehouse/assets/js/inventory/manage_js.php'; ?>
