...
foreach ($order_return->order_return_detail as $key => $order_return_detail) {
	...
	$itemHTML .= '<td class="description" align="left;" width="20%">';
			...
			$itemHTML .= '<td align="right" width="10%">' . app_format_money($order_return_detail['unit_price'], $order_return->currency) . '</td>';
			...
			// sub total
			$itemHTML .= '<td class="amount" align="right" width="12%">' . app_format_money($order_return_detail['sub_total'], $order_return->currency) . '</td>';
			
			// sub total
			$itemHTML .= '<td class="amount" align="right" width="10%">' . $order_return_detail['discount'] . '</td>';
			
			// sub total
			$itemHTML .= '<td class="amount" align="right" width="10%">' . app_format_money($order_return_detail['discount_total'], $order_return->currency) . '</td>';
			...
			$itemHTML .= '<td class="amount" align="right" width="15%">' . app_format_money($order_return_detail['total_after_discount'], $order_return->currency) . '</td>';
...
// var_dump($tblhtml);die;
		...
		<td align="right" width="15%">' . app_format_money($order_return->subtotal, $order_return->currency) . '</td>
		</tr>';
		...
		<td align="right" width="15%">' . app_format_money($discount_total, $order_return->currency) . '</td>
		</tr>';

		$tbltotal .= '
		<tr style="background-color:#f0f0f0;">
		<td align="right" width="85%"><strong>' . _l('total_money') . '</strong></td>
		<td align="right" width="15%">' . app_format_money($order_return->total_after_discount, $order_return->currency) . '</td>
		</tr>';
