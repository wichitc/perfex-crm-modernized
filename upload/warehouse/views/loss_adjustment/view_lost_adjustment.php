    ...
    <?php } ?>
            ...
            <?php }
              if(isset($check_approve_status['staffid'])){
                  ...
                  <?php 
              if((in_array(get_staff_user_id(), $check_approve_status['staffid']) && $loss_adjustment->status == 0 && !isset($check_approve_status['action']) && !in_array(get_staff_user_id(), $get_staff_sign) ) || (  in_array(get_staff_user_id(), $check_approve_status['staffid']) && $loss_adjustment->status == 0 && isset($check_approve_status['action']) && $check_approve_status['action'] == 'approve') ){ ?>
                ...
                <?php }
                  ...
                  <?php
                 if((in_array(get_staff_user_id(), $check_approve_status['staffid']) && in_array(get_staff_user_id(), $get_staff_sign) && $loss_adjustment->status == 0 && !isset($check_approve_status['action'])) || (in_array(get_staff_user_id(), $check_approve_status['staffid']) && in_array(get_staff_user_id(), $get_staff_sign) && $loss_adjustment->status == 0 && isset($check_approve_status['action']) && $check_approve_status['action'] == 'sign')  ){ ?>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div id="upload_sign" class="mbot15 hide">
          ...
          <?php echo form_hidden('approve_rel_id', $loss_adjustment->id) ?>
          <?php echo form_hidden('approve_rel_type', '3') ?>
