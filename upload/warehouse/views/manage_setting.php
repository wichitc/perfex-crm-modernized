...
}elseif(!(strpos($viewuri,'admin/warehouse/setting?group=currency_rates') === false)){
  require('modules/warehouse/assets/js/settings/currency_rates_js.php');
} ?>
</body>
</html>
