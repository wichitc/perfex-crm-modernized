   ...
   <div class="panel_s">
      <div class="panel-body">
         <?php if($goods_delivery->approval == 0){ ?>
           <div class="ribbon info"><span class="label label-tag tag-id-1 label-tab2"><?php echo _l('not_yet_approve'); ?></span></div>
       <?php }elseif($goods_delivery->approval == 1){ ?>
         <div class="ribbon success"><span class="label label-tag tag-id-1 label-tab1"><?php echo _l('approved'); ?></span></div>
       <?php }elseif($goods_delivery->approval == -1){ ?>  
         <div class="ribbon danger"><span class="label label-tag tag-id-1 label-tab3"><?php echo _l('reject'); ?></span></div>
       <?php } ?>
            ...
            <div class="horizontal-tabs">
               <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                 ...
                 <?php } ?>
                  ...
                  <?php hooks()->do_action('after_inventory_delivery_tab', $goods_delivery); ?>
               </ul>
            </div>
         </div>
         ...
         <div class="tab-content">
          <?php hooks()->do_action('after_inventory_delivery_tab_content', isset($goods_delivery) ? $goods_delivery : false); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                     <div class="pull-right _buttons">
                        ...
                        <a href="<?php echo admin_url('warehouse/manage_delivery/'.$goods_delivery->id); ?>" class="btn btn-default btn-with-tooltip" data-toggle="tooltip" title="<?php echo _l('view'); ?>" data-placement="bottom"><i class="fa fa-eye"></i></a>
                        <?php } ?>
        ...
        <div class="col-md-12">
          <?php   
          $cf = get_custom_fields('iv_delivery');
              ...
              <table class="table border table-striped no-mtop">
                <tbody>
                  ...
                  foreach ($cf as $key => $custom_field) {
                    ...
                    $val = get_custom_field_value($goods_delivery->id, $custom_field['id'], 'iv_delivery');
                        ...
                        <div class="table-responsive">
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                            ...
                            if($display_product_image){
                              $item_image = $this->warehouse_model->get_item_image($delivery_value['commodity_code']);
                            }
                            ?>
                              ...
                              <tr>
                                ...
                                <?php } ?>
                                  ...
                                  <td class="text-right"><?php echo app_format_money((float)$item_subtotal, $currency) ?></td>
                                  <td class="text-right"><?php echo app_format_money((float)$total_money, $currency) ?></td>
                             ...
                             <table class="table text-right">
                              <tbody>
                                <tr id="subtotal">
                                  ...
                                  <td><?php echo app_format_money((float)$subtotal, $currency); ?></td>
                                </tr>
                                ...
                                <tr id="total_discount">
                                  ...
                                  <td><?php echo app_format_money((float)$total_discount, $currency); ?></td>
                                </tr>
                                ...
                                <tr id="shipping_fee">
                                  ...
                                  <td><?php echo app_format_money((float)$shipping_fee, $currency); ?></td>
                                </tr>
                              <?php } ?>
                                ...
                                <tr id="totalmoney">
                                 ...
                                 <td class="bold"><?php echo _l('total_money'); ?></td>
                                  <td><?php echo app_format_money((float)$after_discount, $currency); ?></td>
                                </tr>
                              </tbody>
                             </table>
                           </div>
         ...
         <div class="col-md-3 text-center">
             <p class="text-uppercase text-muted no-mtop bold">
              ...
              foreach ($value['staffid'] as $key => $val) {
                ...
                if($get_name){
                  $staff_name .= $get_name->firstname.' '.$get_name->lastname;
                }
              }
    ...
    <?php } ?>
            ...
            <?php }
              if(isset($check_approve_status['staffid'])){
                  ?>
                  <?php 
              if((in_array(get_staff_user_id(), $check_approve_status['staffid']) && $goods_delivery->approval == 0 && !isset($check_approve_status['action']) && !in_array(get_staff_user_id(), $get_staff_sign) ) || (  in_array(get_staff_user_id(), $check_approve_status['staffid']) && $goods_delivery->approval == 0 && isset($check_approve_status['action']) && $check_approve_status['action'] == 'approve') ){ ?>
                ...
                <?php
                 if((in_array(get_staff_user_id(), $check_approve_status['staffid']) && in_array(get_staff_user_id(), $get_staff_sign) && $goods_delivery->approval == 0 && !isset($check_approve_status['action'])) || (in_array(get_staff_user_id(), $check_approve_status['staffid']) && in_array(get_staff_user_id(), $get_staff_sign) && $goods_delivery->approval == 0 && isset($check_approve_status['action']) && $check_approve_status['action'] == 'sign')  ){ ?>
             ...
             <div class="radio radio-primary radio-inline">
                 ...
                 <label for="sign">
                  ...
                  <div id="upload_sign" class="mbot15 hide">
                    ...
                    <?php echo form_hidden('approve_rel_id', $goods_delivery->id) ?>
                    <?php echo form_hidden('approve_rel_type', '2') ?>
...
<?php hooks()->do_action('inventory_delivery_load_js'); ?>
