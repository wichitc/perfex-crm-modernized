        ...
        for ($i = 0; $i < count($aColumns); $i++) {
            $_data = $aRow[$aColumns[$i]];
             ...
             if($aColumns[$i] == 'commodity_code') {
                ...
                $_data = app_format_money((float)$aRow[db_prefix().'items.purchase_price'], $base_currency);
        ...
        for ($i = 0; $i < count($aColumns); $i++) {
            ...
            $_data = $aRow[$aColumns[$i]];
             ...
             if($aColumns[$i] == 'commodity_code') {
                ...
                $_data = app_format_money((float)$aRow[db_prefix().'inventory_manage.purchase_price'], $base_currency);
