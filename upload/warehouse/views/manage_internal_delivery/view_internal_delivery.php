      ...
      <div class="panel-body">
       ...
       <?php } ?>
         <div class="horizontal-scrollable-tabs preview-tabs-top">
            ...
            <div class="horizontal-tabs">
               <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                  ...
                  <?php hooks()->do_action('after_internal_delivery_tab', $internal_delivery); ?>
               </ul>
            </div>
         </div>
         ...
         <div class="tab-content">
          <?php hooks()->do_action('after_internal_delivery_tab_content', isset($internal_delivery) ? $internal_delivery : false); ?>
                           ...
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                            ...
                            $unit_name ='';
                             if(is_numeric($internal_delivery_value['unit_id'])){
                              ...
                              if(new_strlen($internal_delivery_value['note']) > 0){
                                $commodity_name .= '<br>'.$internal_delivery_value['note'];
                              }
                            ?>
    ...
    <?php } ?>
            ...
            <?php }
              if(isset($check_approve_status['staffid'])){
                  ?>
                  <?php 
              if((in_array(get_staff_user_id(), $check_approve_status['staffid']) && $internal_delivery->approval == 0 && !isset($check_approve_status['action']) && !in_array(get_staff_user_id(), $get_staff_sign) ) || (  in_array(get_staff_user_id(), $check_approve_status['staffid']) && $internal_delivery->approval == 0 && isset($check_approve_status['action']) && $check_approve_status['action'] == 'approve') ){ ?>
                  <div class="btn-group" >
                ...
                <?php
                 if((in_array(get_staff_user_id(), $check_approve_status['staffid']) && in_array(get_staff_user_id(), $get_staff_sign) && $internal_delivery->approval == 0 && !isset($check_approve_status['action'])) || (in_array(get_staff_user_id(), $check_approve_status['staffid']) && in_array(get_staff_user_id(), $get_staff_sign) && $internal_delivery->approval == 0 && isset($check_approve_status['action']) && $check_approve_status['action'] == 'sign')  ){ ?>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div id="upload_sign" class="mbot15 hide">
          ...
          <?php echo form_hidden('approve_rel_id', $internal_delivery->id) ?>
          <?php echo form_hidden('approve_rel_type', '4') ?>
...
<?php hooks()->do_action('internal_delivery_load_js'); ?>
