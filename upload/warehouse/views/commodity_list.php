                ...
                <?php echo form_hidden('proposal_id',$proposal_id); ?>
                  ...
                  <div class="row">
                           ...
                           <div class="modal-content">
                              ...
                              <div class="modal-body">
                                 ...
                                 <div class="row display-select-item hide ">
                                   ...
                                   <div class="col-md-6">
                                      <div class="form-group">
                                          <div class="checkbox checkbox-primary checkbox-inline" >
                                              <input type="checkbox" id="custom_printing" name="custom_printing" >
                                              <label for="custom_printing"><?php echo _l('wh_custom'); ?></label>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="custom_printing_hide hide">
                                  <div class="row">
                                    <div class="col-md-12">

                                    <div class="form-group">
                                      <div class="radio radio-primary radio-inline" >
                                        <input type="radio" id="paper_roll" name="print_mode" value="paper_roll" checked>
                                                <label for="paper_roll"><?php echo _l('wh_printer_sticker_paper_roll'); ?></label>
                                      </div>
                                    
                                      <div class="radio radio-primary radio-inline">
                                        <input type="radio" id="a4" name="print_mode" value="a4">
                                        <label for="a4"><?php echo _l('wh_a4'); ?></label>
                                      </div>
                                    </div>
                                  </div>
                                  </div>
                                  <div class="row">
                                    <div class="col-md-7">
                                      <?php echo render_select('label_sizes', $standard_label_sizes, ['name', 'label'], 'wh_standard_label_sizes'); ?>
                                      <p class="tw-font-medium"><?php echo _l('wh_dimensions'); ?></p>
                                      <div class="row">
                                        <div class="col-md-8">
                                          <label><?php echo _l('wh_number_of_label_in_row'); ?></label>
                                        </div>
                                        <div class="col-md-4">
                                          <?php echo render_input('number_of_label_in_row'); ?>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-8">
                                          <label><?php echo _l('wh_number_of_row'); ?></label>
                                        </div>
                                        <div class="col-md-4">
                                          <?php echo render_input('number_of_row'); ?>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-8">
                                          <label><?php echo _l('wh_label_width').' (mm)'; ?></label>
                                        </div>
                                        <div class="col-md-4">
                                          <?php echo render_input('label_width'); ?>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-8">
                                          <label><?php echo _l('wh_label_height').' (mm)'; ?></label>
                                        </div>
                                        <div class="col-md-4">
                                          <?php echo render_input('label_height'); ?>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-8">
                                          <label><?php echo _l('wh_horizontal_distance').' (mm)'; ?></label>
                                        </div>
                                        <div class="col-md-4">
                                          <?php echo render_input('horizontal_distance'); ?>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-8">
                                          <label><?php echo _l('wh_vertical_distance').' (mm)'; ?></label>
                                        </div>
                                        <div class="col-md-4">
                                          <?php echo render_input('vertical_distance'); ?>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-8">
                                          <label><?php echo _l('wh_distance_from_page_left').' (mm)'; ?></label>
                                        </div>
                                        <div class="col-md-4">
                                          <?php echo render_input('distance_from_page_left'); ?>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-8">
                                          <label><?php echo _l('wh_distance_from_the_top_of_the_page').' (mm)'; ?></label>
                                        </div>
                                        <div class="col-md-4">
                                          <?php echo render_input('distance_from_the_top_of_the_page'); ?>
                                        </div>
                                      </div>
                    ...
                    <?php if (is_mobile()) { ?>
                      ...
                      <?php } ?>
                      <div id="scanner-wrapper" class="tw-hidden mtop15" >
                        <div id="reader">
                        </div>
                        <div id="scan-overlay">
                          ...
                          <div class="col-md-11">
                           ...
                           <div class="col-md-8">
                            ...
                            <?php 
                             ...
                             ?>
                            <span class="pull-left fa fa-question-circle" data-toggle="tooltip" title="" data-original-title="<?php echo _l('wh_variation_tooltip'); ?>"></span>
