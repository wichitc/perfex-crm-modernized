                    ...
                    <div class="panel-body">               
                        ...
                        <div class="col-md-12">
                         ...
                         <div class="row col-md-12">
                                ...
                                <?php if(isset($commodity_file) && count($commodity_file) > 0){ ?>
                                  <?php foreach ($commodity_file as $key => $value) { ?>
                                      ...
                                      <?php if(file_exists(WAREHOUSE_ITEM_UPLOAD .$value["rel_id"].'/'.$value["file_name"])){ ?>
                                       ...
                                       <?php }elseif(file_exists('modules/rental/uploads/products/' . $value["rel_id"] . '/' . $value["file_name"])){ ?>
                                          <a  class="images_w_table" href="<?php echo site_url('modules/rental/uploads/products/'.$value["rel_id"].'/'.$value["file_name"]); ?>"><img class="images_w_table" src="<?php echo site_url('modules/rental/uploads/products/'.$value["rel_id"].'/'.$value["file_name"]); ?>" alt="<?php echo new_html_entity_decode($value['file_name']) ?>"/></a>
                            ...
                            echo new_html_entity_decode($_img);
                        }
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <?php hooks()->do_action('warehouse_commodity_detail_after_general_info', [
                                ...
                                <tbody>
                                   ...
                                   <tr class="project-overview">
                                    ...
                                    <tr class="project-overview">
                                      ...
                                      <td><?php echo app_format_money((float)$commodity_item->rate, $base_currency_id) ; ?></td>
                                   </tr>
                                ...
                                <tbody>
                                   ...
                                   <tr class="project-overview">
                                     ...
                                     <tr class="project-overview">
                                        ...
                                        <td><?php echo app_format_money((float)$commodity_item->purchase_price, $base_currency_id) ; ?></td>
                                     </tr>
