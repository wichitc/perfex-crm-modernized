				...
				<div class="panel_s">
					...
					<div class="panel-body">
						...
						if(isset($packing_list)){
							...
							$currency_exchange_rate = $packing_list->currency_exchange_rate;
						}
						?>
...
custom_name_for_m3 -->
						...
						<div class="row">
							<div class="col-md-12">
								<?php echo render_custom_fields('iv_packing_list', isset($packing_list) ? $packing_list->id : ''); ?>
							</div>
						</div>
							...
							<table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
								<thead>
									<tr>
										...
										<th width="10%" align="right" class="<?php if(get_option('packing_list_expiry_date') == 0){ echo " hide";} ?>"><?php echo _l('expiry_date'); ?></th>
