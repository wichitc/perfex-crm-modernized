		...
		<div class="row">
			<div class="col-md-12" id="small-table">
				...
				$table_data = array(
						...
						$cf = get_custom_fields('iv_packing_list',array('show_on_table'=>1));
                      foreach($cf as $custom_field) {
                        array_push($table_data,$custom_field['name']);
                      }

                      render_datatable($table_data,'table_manage_packing_list',
                          array('customizable-table'),
                          array(
                            'packing_list_sm' => 'packing_list_sm',
                             'id'=>'table-table_manage_packing_list',
                             'data-last-order-identifier'=>'table_manage_packing_list',
                             'data-default-order'=>get_table_last_order('table_manage_packing_list'),
                           ));
