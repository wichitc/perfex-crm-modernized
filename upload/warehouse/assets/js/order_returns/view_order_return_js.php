<script>
	...
	(function ($) {
		...
		<?php if (isset($send_mail_approve)) {
			...
			data_send_mail.rel_id = <?php echo new_html_entity_decode($order_return->id); ?>;
			data_send_mail.rel_type = '6';

			data_send_mail.addedfrom = <?php echo new_html_entity_decode($order_return->staff_id); ?>;
	...
	function approve_request(id) {
		...
		var data = {};
		data.rel_id = <?php echo new_html_entity_decode($order_return->id); ?>;
		data.rel_type = '6';
		data.order_rel_type = '<?php echo new_html_entity_decode($order_return->rel_type); ?>';

		data.addedfrom = <?php echo new_html_entity_decode($order_return->staff_id); ?>;
