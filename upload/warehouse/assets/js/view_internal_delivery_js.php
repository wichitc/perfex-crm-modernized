...
var croppedCtx;
  ...
  <?php if(isset($send_mail_approve)){ 
    ...
    data_send_mail.rel_id = <?php echo new_html_entity_decode($internal_delivery->id); ?>;
    data_send_mail.rel_type = '4';
    
    data_send_mail.addedfrom = <?php echo new_html_entity_decode($internal_delivery->addedfrom); ?>;
  ...
  function send_request_approve(id){
    "use strict";
      var data = {};
      data.rel_id = <?php echo new_html_entity_decode($internal_delivery->id); ?>;
      data.rel_type = '4';
     
      data.addedfrom = <?php echo new_html_entity_decode($internal_delivery->addedfrom); ?>;
