...
<table class="table dt-table">
 ...
 <tbody>
    ...
    <tr>
       ...
       <td>
         <a href="#" onclick="edit_asset_location(this,<?php  echo htmlspecialchars($c['location_id']); ?>); return false" data-name="<?php  echo htmlspecialchars($c['location']); ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></a>
          <a href="<?php echo admin_url('assets/delete_asset_location/'.$c['location_id']); ?>" class="btn btn-danger btn-xs _delete"><i class="fa fa-trash"></i></a>
       </td>
    </tr>
    <?php } ?>
 </tbody>
