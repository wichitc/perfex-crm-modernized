    ...
    function setFontFamily($family, $options = '')
    {
        if (!is_array($options)) {
            if ($family === 'init') {
                ...
                $this->fontFamilies['Garamond.afm'] =
                    [
                        'b'  => 'Garamond-Bold.afm',
                        'i'  => 'Garamond-Italic".afm',
                        'bi' => 'Garamond-BoldItalic.afm',
                        'ib' => 'Garamond-BoldItalic.afm'
                    ];

                $this->fontFamilies['Roboto.afm'] =
                    [
                        'b'  => 'Roboto-Bold.afm',
                        'i'  => 'Roboto-Italic".afm',
                        'bi' => 'Roboto-BoldItalic.afm',
                        'ib' => 'Roboto-BoldItalic.afm'
                    ];
            }
        } else {
