<script>
  ...
  $( document ).ready(function() {
      ...
      $('li.sub-menu-item-accounting_vendors').addClass('active');
      ...
      {
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/accounting/uploads/file_sample/Sample_import_vendor_file_vi.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );

      }else{
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/accounting/uploads/file_sample/Sample_import_vendor_file_en.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );
      }
    });
...
function uploadfilecsv(){
  "use strict";
    ...
    $.ajax({ 
      url: admin_url + 'accounting/import_file_xlsx_vendor', 
      method: 'post', 
      data: formData, 
      contentType: false, 
      processData: false
