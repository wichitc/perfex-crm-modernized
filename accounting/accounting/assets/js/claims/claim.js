document.addEventListener("DOMContentLoaded", function() {
    ...
    $(document).on('change', '#project_id, #category_id, #expense_date', check_claim_budget);
    $(document).on('keyup change', '#amount', check_claim_budget);
});
