...
var fnServerParams;
var beginning_balance = <?php echo new_html_entity_decode($reconcile->beginning_balance); ?>;
var ending_balance = <?php echo new_html_entity_decode($reconcile->ending_balance); ?>;
var difference = 0;
...
function init_history_table() {
  ...
  var _table = initDataTable('.table-reconcile-history', admin_url + 'accounting/reconcile_history_table', false, [0], fnServerParams, [1, 'asc']);
}
...
function delete_transaction(id) {
  "use strict";
    if (confirm("Are you sure?")) {
      var url = admin_url + 'accounting/delete_transaction/'+id;
