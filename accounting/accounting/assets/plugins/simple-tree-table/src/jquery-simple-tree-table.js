    ...
    var s = "simple-tree-table"
      ...
      , r = function() {
        ...
        t = [{
                ...
                this.nodes().each(function(e, t) {
                    ...
                    if (0 === n.find(".tree-icon").length) {
                        ...
                        var i = r.depth(n, 0)
                          ...
                          , a = $('<span class="tree-icon" />').addClass("margin-left-".concat(o, "")).css("margin-left", "".concat(o, "px"));
                        s && a.addClass("tree-opened margin-left-".concat(o, "")),
                        n.children(":first").prepend(a)
                    }
                })
            }
        }, {
            ...
            key: "unbind",
            value: function() {
                this.$expander.off(".".concat(s)),
                this.$collapser.off(".".concat(s)),
                this.$tree.off(".".concat(s))
            }
        }, {
            key: "expand",
            value: function() {
            ...
            value: function(e) {
                ...
                t.hasClass("tree-closed") && (t.removeClass("tree-closed").addClass("tree-opened"),
                this.showDescs(e))
            }
        }, {
            key: "showDescs",
            value: function(e) {
                ...
                this.findChildren(e).each(function(e, t) {
                    var n = $(t)
                      , i = n.find(".tree-icon");
                    n.show(),
                    i.hasClass("tree-opened") && o.showDescs(n)
                })
            }
        }, {
            key: "close",
            ...
            value: function(e) {
                var t = e.find(".tree-icon");
                t.hasClass("tree-opened") && (t.removeClass("tree-opened").addClass("tree-closed"),
                this.hideDescs(e))
            }
        }, {
            key: "hideDescs",
