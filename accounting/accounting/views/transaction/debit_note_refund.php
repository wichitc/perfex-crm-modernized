...
<a href="#" data-toggle="modal" data-target="#debit_notes_refund_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-debit-notes-refund"><?php echo _l('bulk_actions'); ?></a>
<?php 
$table_data = [
...
array_unshift($table_data, [
    'name'     => '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="debit-notes-refund"><label></label></div>',
        'th_attrs' => ['class' => (isset($bulk_actions) ? '' : 'not_visible')],
]);

render_datatable($table_data, 'debit-notes-refund', [], [
        'data-last-order-identifier' => 'debit-notes-refund',
        'data-default-order'         => get_table_last_order('debit-notes-refund'),
]);
?>
<?php $arrAtt = array();
...
<div class="modal fade bulk_actions" id="debit_notes_refund_bulk_actions" tabindex="-1" role="dialog" data-table=".table-debit-notes-refund">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          <?php echo form_hidden('bulk_actions_type', 'debit_note_refund'); ?>
