...
<a href="#" data-toggle="modal" data-target="#components_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-components"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-components">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="components"><label></label></div></th>
