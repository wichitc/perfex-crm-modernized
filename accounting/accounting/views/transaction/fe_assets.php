...
<a href="#" data-toggle="modal" data-target="#assets_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-assets"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-assets">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="assets"><label></label></div></th>
