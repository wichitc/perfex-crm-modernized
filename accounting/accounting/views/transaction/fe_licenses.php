...
<a href="#" data-toggle="modal" data-target="#licenses_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-licenses"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-licenses">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="licenses"><label></label></div></th>
