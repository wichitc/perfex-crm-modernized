...
<a href="#" data-toggle="modal" data-target="#consumables_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-consumables"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-consumables">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="consumables"><label></label></div></th>
