...
<a href="#" data-toggle="modal" data-target="#purchase_refund_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-purchase-refund"><?php echo _l('bulk_actions'); ?></a>
<?php 
$table_data = [
    _l('invoice_payments_table_date_heading'),
    _l('refund_amount'),
    _l('payment_mode'),
    _l('purchase_order_return'),
    _l('status'),
    _l('acc_convert'),
];

array_unshift($table_data, [
    'name'     => '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="purchase-refund"><label></label></div>',
        'th_attrs' => ['class' => (isset($bulk_actions) ? '' : 'not_visible')],
]);

render_datatable($table_data, 'purchase-refund', [], [
        'data-last-order-identifier' => 'purchase_refund',
        'data-default-order'         => get_table_last_order('purchase_refund'),
]);
?>
<?php $arrAtt = array();
...
<div class="modal fade bulk_actions" id="purchase_refund_bulk_actions" tabindex="-1" role="dialog" data-table=".table-purchase-refund">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          <?php echo form_hidden('bulk_actions_type', 'purchase_refund'); ?>
