...
<a href="#" data-toggle="modal" data-target="#purchase_invoice_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-purchase-invoice"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-purchase-invoice">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="purchase-invoice"><label></label></div></th>
    <th><?php echo _l('invoice_no'); ?></th>
    <th><?php echo _l('vendor'); ?></th>
    <th><?php echo _l('contract'); ?></th>
    <th><?php echo _l('pur_order'); ?></th>
    <th><?php echo _l('invoice_date'); ?></th>
    <th><?php echo _l('recurring_from'); ?></th>
    <th><?php echo _l('invoice_amount'); ?></th>
    <th><?php echo _l('tax_value'); ?></th>
    <th><?php echo _l('total_included_tax'); ?></th>
    <th><?php echo _l('payment_request_status'); ?></th>
...
<div class="modal fade bulk_actions" id="purchase_invoice_bulk_actions" tabindex="-1" role="dialog" data-table=".table-purchase-invoice">
