...
<a href="#" data-toggle="modal" data-target="#debit_notes_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-debit-notes"><?php echo _l('bulk_actions'); ?></a>
<?php 
$table_data = [
...
array_unshift($table_data, [
    'name'     => '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="debit-notes"><label></label></div>',
        'th_attrs' => ['class' => (isset($bulk_actions) ? '' : 'not_visible')],
]);

render_datatable($table_data, 'debit-notes', [], [
        'data-last-order-identifier' => 'debit-notes',
        'data-default-order'         => get_table_last_order('debit-notes'),
]);
?>
<?php $arrAtt = array();
...
<div class="modal fade bulk_actions" id="debit_notes_bulk_actions" tabindex="-1" role="dialog" data-table=".table-debit-notes">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          <?php echo form_hidden('bulk_actions_type', 'debit_note'); ?>
