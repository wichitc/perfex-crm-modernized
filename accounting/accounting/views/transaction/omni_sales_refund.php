...
<a href="#" data-toggle="modal" data-target="#omni_sales_refund_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-omni-sales-refund"><?php echo _l('bulk_actions'); ?></a>
<?php 
$table_data = [
...
array_unshift($table_data, [
    'name'     => '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="omni-sales-refund"><label></label></div>',
        'th_attrs' => ['class' => (isset($bulk_actions) ? '' : 'not_visible')],
]);

render_datatable($table_data, 'omni-sales-refund', [], [
        'data-last-order-identifier' => 'omni_sales_refund',
        'data-default-order'         => get_table_last_order('omni_sales_refund'),
]);
?>
<?php $arrAtt = array();
...
<div class="modal fade bulk_actions" id="omni_sales_refund_bulk_actions" tabindex="-1" role="dialog" data-table=".table-omni-sales-refund">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          <?php echo form_hidden('bulk_actions_type', 'omni_sales_refund'); ?>
