<div class="row">
  <div class="col-md-3">
        <?php echo render_select('product',$products,array('id','description'),'products', '', array('multiple' => true, 'data-actions-box' => true), array(), '', '', false); ?>
  </div>
  <div class="col-md-3">
...
<a href="#" data-toggle="modal" data-target="#manufacturing_order_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-manufacturing-order"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-manufacturing-order">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="manufacturing-order"><label></label></div></th>
