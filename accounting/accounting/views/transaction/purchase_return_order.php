...
<a href="#" data-toggle="modal" data-target="#purchase_order_return_bulk_actions" class="hide bulk-actions-btn table-btn" data-table=".table-purchase-order-return"><?php echo _l('bulk_actions'); ?></a>
<table class="table table-purchase-order-return">
  <thead>
    <th><span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="purchase-order-return"><label></label></div></th>
    <th><?php echo _l('pur_order_return_number'); ?></th>
    <th><?php echo _l('pur_vendor'); ?></th>
    <th><?php echo _l('pur_total_amount'); ?></th>
    <th><?php echo _l('pur_discount_total'); ?></th>
    <th><?php echo _l('pur_total_after_discount'); ?></th>
    <th><?php echo _l('pur_datecreated'); ?></th>
    <th><?php echo _l('pur_status_label'); ?></th>
...
<div class="modal fade bulk_actions" id="purchase_order_return_bulk_actions" tabindex="-1" role="dialog" data-table=".table-purchase-order-return">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
          <?php echo form_hidden('bulk_actions_type', 'purchase_order_return'); ?>
