  ...
  <div class="card">
    <table class="tree">
      <tbody>
        ...
        <tr class="tr_header">
          <td width="70%" class="text-bold"><?php echo _l('acc_account'); ?></td>
          <td width="15%" class="th_total text-bold"><?php echo _l('debit'); ?></td>
          <td width="15%" class="th_total text-bold"><?php echo _l('credit'); ?></td>
        </tr>
        <?php
          $row_index = 0;
          $parent_index = 0;
          ...
          <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" data-node-pid="10000" class="tr_total">
