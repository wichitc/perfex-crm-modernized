<div id="accordion">
  <div class="card">
    <table class="tree">
      ...
      <tbody>
        <tr data-node-id="01" class="parent-node expanded">
          <td colspan="14">
        ...
        <tr data-node-id="02" class="parent-node expanded">
          <td colspan="14">
            <h4 class="text-center"><?php echo _l('profit_and_loss_12_months'); ?></h4>
          </td>
          <td></td>
          <?php 
            $start = $month = strtotime($data_report['from_date']);
        ...
        <tr data-node-id="03" class="parent-node expanded">
          <td colspan="14">
        ...
        <tr class="tr_header">
          ...
          while($month <= $end || date('Y-m', $month) == date('Y-m', $end))
          {
            echo '<td width="6%" class=" text-bold">'.date('F', $month).'<br>'.date('Y', $month).'</td>';
              $month = strtotime("+1 month", $month);
          }
          ?>
          <td width="10%" class="th_total_width_auto text-bold"><?php echo _l('total'); ?></td>
        </tr>
        <?php
          $row_index = 0;
          $parent_index = 0;
          ...
          <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" class="parent-node expanded tr_total">
            ...
            ?>
            <td class="total_amount custom-text-wrap"><?php echo app_format_money($total_income, $currency->name); ?> </td>
          </tr>
          ...
          <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" class="parent-node expanded tr_total">
            ...
            ?>
            <td class="total_amount custom-text-wrap"><?php echo app_format_money($total_cost_of_sales, $currency->name); ?> </td>
          </tr>
          <?php
          $row_index += 1;
          $parent_index = $row_index;
          ...
          ?>
            ...
            <?php 
              $_index = $row_index;
              $data = $this->accounting_model->get_html_profit_and_loss_12_months($data_report['data']['net_income'], ['html' => '', 'row_index' => $row_index + 1, 'total_amount' => 0, 'total_py_amount' => 0], $parent_index, $currency);
              $row_index = $data['row_index'];
              echo new_html_entity_decode($data['html']);
            ...
            <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" class="parent-node expanded tr_total">
              ...
              ?>
              <td class="total_amount custom-text-wrap"><?php echo app_format_money($total_net_income, $currency->name); ?> </td>
            </tr>
          <?php } ?>
          <?php $row_index += 1; ?>
          ...
          <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" class="parent-node expanded tr_total">
            ...
            ?>
            <td class="total_amount custom-text-wrap"><?php echo app_format_money($total_income - $total_cost_of_sales, $currency->name); ?> </td>
          </tr>
          <?php } ?>
          ...
          <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" class="parent-node expanded tr_total">
            ...
            ?>
            <td class="total_amount custom-text-wrap"><?php echo app_format_money($total_other_income, $currency->name); ?> </td>
          </tr>
          <?php $row_index += 1;
            $parent_index = $row_index;
          ?>
          ...
          <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" class="parent-node expanded tr_total">
            ...
            ?>
            <td class="total_amount custom-text-wrap"><?php echo app_format_money($total_expenses, $currency->name); ?> </td>
          </tr>
          <?php $row_index += 1;
            $parent_index = $row_index;
          ?>
          ...
          <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" class="parent-node expanded tr_total">
            ...
            ?>
            <td class="total_amount custom-text-wrap"><?php echo app_format_money($total_other_expenses, $currency->name); ?> </td>
          </tr>
          <?php $row_index += 1; ?>
          <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" class="parent-node expanded tr_total">
            ...
            ?>
            <td class="total_amount custom-text-wrap"><?php echo app_format_money(($total_income + $total_net_income + $total_other_income) - ($total_cost_of_sales + $total_expenses + $total_other_expenses), $currency->name); ?> </td>
          </tr>
        </tbody>
    </table>
  </div>
