  ...
  <div class="card">
    <table class="tree">
      <tbody>
        ...
        <tr class="tr_header">
          <td width="70%"></td>
          <td width="30%" class="text-right text-bold"><?php echo _l('total'); ?></td>
        </tr>
        <?php
          $row_index = 1;
          ?>
          ...
          <?php $row_index += 1; ?>
          <tr data-node-id="<?php echo new_html_entity_decode($row_index); ?>" data-node-pid="10000" class="border_top">
            <td >
