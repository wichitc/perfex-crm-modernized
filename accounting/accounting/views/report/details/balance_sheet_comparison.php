  ...
  <div class="card">
    <table class="tree">
      <tbody>
        <tr>
          <td colspan="3">
              <h3 class="text-center"><?php echo new_html_entity_decode(get_option('companyname')); ?></h3>
          </td>
          <td></td>
          <td></td>
        </tr>
        ...
        <tr>
          <td colspan="3">
            <?php if ($data_report['date_filter_type'] == 'to_date') { ?>
              <p class="text-center"><?php echo _l('as_of').' '. _d($data_report['to_date']); ?></p>
            <?php }else{ ?>
        ...
        <tr class="border-top">
          <td width="70%"></td>
          <td width="30%" colspan="2" class="text-center th_total text-bold"><?php echo _l('total'); ?></td>
          <td></td>
        </tr>
