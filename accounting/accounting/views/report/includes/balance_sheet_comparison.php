            ...
            <div class="col-md-10">
              ...
              <?php echo form_open(admin_url('accounting/view_report'),array('id'=>'filter-form')); ?>
                <div class="col-md-3">
                  <?php 
                  $date_filter_type = [
                          1 => ['id' => 'to_date', 'name' => _l('to_date')],
                          2 => ['id' => 'from_and_to', 'name' => _l('from_date_and_to_date')],
                         ];
                  echo render_select('date_filter_type', $date_filter_type, array('id', 'name'),'date_filter_type', 'as_of', array(), array(), '', '', false);
                  ?>
                </div>
