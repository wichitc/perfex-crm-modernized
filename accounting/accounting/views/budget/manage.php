      ...
      <div class="panel-body backdrop">
        ...
        <div class="row">
          ...
          <div class=" col-md-6 pull-right">
            ...
            <a href="#" onclick="creating_a_budget(); return false;" class="px-0 btn btn-info mtop25 pull-right <?php if(!has_permission('accounting_budget', '', 'create')){echo 'hide';} ?>"><?php echo _l('acc_new'); ?></a>
          </div>
        </div>
        <div id="div_data">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="#" onclick="new_budget(); return false;" class="px-0 btn btn-info"><?php echo _l('finish'); ?></a>
      </div>
    </div>
  </div>
</div>
<div class="modal fade" id="budget-exists-modal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="#" onclick="previous_year_and_type(); return false;" class="px-0 btn btn-default"><?php echo _l('previous'); ?></a>
        <a href="#" onclick="update_budget(); return false;" class="px-0 btn btn-info"><?php echo _l('finish'); ?></a>
      </div>
    </div>
  </div>
</div>
