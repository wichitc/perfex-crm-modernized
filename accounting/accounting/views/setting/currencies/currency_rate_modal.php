<div class="modal fade" id="currencyRateModal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<?php echo form_open(admin_url('accounting/update_currency_rate/'.$currency_rate->id), array('id' => 'update_currency_rate')); ?>
								...
								<div class="input-group-addon">
									<div class="dropdown">
										<span class="discount-type-selected">
											<?php echo acc_get_currency_name_symbol($currency_rate->from_currency_id, 'symbol') ;?>
										</span>
						...
						<div class="col-md-5">
							<div class="input-group" id="discount-total">
								...
								<div class="input-group-addon">
									<div class="dropdown">
										<span class="discount-type-selected">
											<?php echo acc_get_currency_name_symbol($currency_rate->to_currency_id, 'symbol') ;?>
										</span>
