...
class Staffs extends REST_Controller {
    ...
    public function data_search_get($key = '')
    {
        ...
        // This allows: /api/staffs/search/term OR /api/staffs/search?q=term
        ...
        if (empty($key)) {
            $this->response(['status' => FALSE, 'message' => 'Search term is required. Use /api/staffs/search/{term} or /api/staffs/search?q={term}'], REST_Controller::HTTP_BAD_REQUEST);
            return;
        }
    ...
    public function data_put($id)
    {
        ...
        else
        {
            ...
            $update_data = $this->api_sanitize_update_payload('staff', $update_data, ['custom_fields', 'departments', 'permissions', 'password']);
