<div class="modal fade _project_file" tabindex="-1" role="dialog" data-toggle="modal">
   <div class="modal-dialog full-screen-modal" role="document" class="ap-width65">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-12 border-right project_file_area">
                  ...
                  <?php } ?>
                  <?php
                     $path = ACCOUNT_PLANNING_ATTACHMENTS_FOLDER .$file->rel_id.'/'.$file->file_name;
                     if(is_image($path)){ ?>
                  <img src="<?php echo base_url('modules/accountplanning/uploads/'.$file->rel_id.'/'.$file->file_name); ?>" class="img img-responsive" class="ap-auto-margin">
                  ...
                  <iframe src="<?php echo base_url('modules/accountplanning/uploads/'.$file->rel_id.'/'.$file->file_name); ?>" height="100%" width="100%" frameborder="0"></iframe>
                  <?php } else if(strpos($file->file_name,'.xls') !== false && empty($file->external)){ ?>
                  <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=<?php echo base_url('modules/accountplanning/uploads/'.$file->rel_id.'/'.$file->file_name); ?>' width='100%' height='100%' frameborder='0'>
                  </iframe>
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-default" onclick="close_modal_manually('._project_file'); return false;"><?php echo htmlspecialchars(_l('close')); ?></button>
         </div>
      </div>
      <!-- /.modal-content -->
   </div>
