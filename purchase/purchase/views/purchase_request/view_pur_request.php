                  ...
                  <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                              <thead>
                                 <tr>
                                   <th scope="col"><span class="bold">#</span></th>  
                              ...
                              <tbody class="ui-sortable">
                                 ...
                                 <tr nobr="true" class="sortable">
                                     ...
                                     <td>
                                    <?php $item = get_item_hp($es['item_code']); 
                                    $_data = '';
                                    if(isset($item->id)){
                                       $arr_images = $this->purchase_model->get_item_attachments($item->id);
                          ...
                          <table class="table table-bordered compare_quotes_table">
                            ...
                            <tbody>
                              ...
                              <?php foreach($list_items as $key => $item){ ?>
                                <tr>
                                 <?php $it = get_item_hp($item['item_code']);  ?>
                                  ...
                                  <td><?php $item_name = isset($it->description) ? $it->description : '';
