				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group profile-positon-group">
							...
							<input type="text" class="form-control" name="title" id="title" value="<?php echo pur_html_entity_decode($contact->title); ?>">
						</div>
						<div class="form-group profile-email-group">
							<label for="email"><?php echo _l('clients_email'); ?></label>
							<input type="email" name="email" class="form-control" id="email" value="<?php echo pur_html_entity_decode($contact->email); ?>">
							<?php echo form_error('email'); ?>
						</div>
						<div class="form-group profile-phone-group">
							<label for="phonenumber"><?php echo _l('clients_phone'); ?></label>
							<input type="text" class="form-control" name="phonenumber" id="phonenumber" value="<?php echo pur_html_entity_decode($contact->phonenumber); ?>">
						</div>
