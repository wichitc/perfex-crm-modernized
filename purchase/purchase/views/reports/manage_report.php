               ...
               <div class="panel-body">
	                 <div class="row">
	                     <div class="col-md-4 border-right">
	                      ...
	                      <hr class="hr-10" />
	                      <p><a href="#" class="font-medium" onclick="init_report(this,'purchase_invoice_payment_rp'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('purchase_invoice_payment_rp'); ?></a></p>
		                 ...
		                 <div class="col-md-4">
			                ...
			                <?php } ?>
		                     ...
		                     <div class="form-group hide" id="approve_status_f" >
		                     	<label for="approve_status"><?php echo _l('pur_approve_status'); ?></label><br />
		                        <select  name="approve_status" id="approve_status"  class="selectpicker"  data-width="100%" >
		                              <option value="" <?php echo 'selected' ?>><?php echo _l('all'); ?></option>
		                              <option value="1"><?php echo _l('draft'); ?></option>
		                              <option value="2"><?php echo _l('approved'); ?></option>
		                              <option value="3"><?php echo _l('reject'); ?></option>
		                              <option value="4"><?php echo _l('cancelled'); ?></option>
		                        </select>
		                     </div>

		                     <div class="form-group hide" id="payment_mode_f" >
		                     	<label for="payment_mode"><?php echo _l('payment_mode'); ?></label><br />
		                        <select  name="payment_mode" id="payment_mode"  class="selectpicker"  data-width="100%" >
		                              <option value="" <?php echo 'selected' ?>><?php echo _l('all'); ?></option>
		                              <?php foreach($payment_modes as $mode){ ?>
		                              	 <option value="<?php echo pur_html_entity_decode($mode['id']); ?>"><?php echo pur_html_entity_decode($mode['name']); ?></option>
		                              <?php } ?>
		                        </select>
		                     </div>
		                 </div>
			        ...
			        <div id="report" class="hide">
			          	...
			          	<div class="col-md-12">
			          		<?php $this->load->view('purchase_invoice_payment_rp'); ?>
			          	</div>
