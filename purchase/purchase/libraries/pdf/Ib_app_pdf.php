...
include_once(APPPATH . 'libraries/pdf/PDF_Signature.php');

/**
 * This class describes an ib application pdf.
 */
abstract class Ib_app_pdf extends TCPDF
{
    use PDF_Signature;
     ...
     *
     * @return     int|string  The default font size.
     */
     ...
     *
     * @return     string  The default font name.
     */
    ...
    /**
     * Sets the default view variables.
     */
