<div class="panel_s">
	<div class="panel-body">
		<?php if($proposals->status == 1){ ?>
	    	<div class="ribbon info hide"><span><?php echo _l('_proposal'); ?></span></div>
		<?php }elseif($proposals->status == 2){ ?>
			<div class="ribbon success hide"><span><?php echo _l('approved'); ?></span></div>
		<?php }elseif($proposals->status == 3){ ?>	
			<div class="ribbon warning hide"><span><?php echo _l('made_finish'); ?></span></div>
		<?php }elseif($proposals->status == 4){ ?>
			<div class="ribbon danger hide"><span><?php echo _l('reject'); ?></span></div>
		<?php } ?>
    	...
    	<div class="col-md-6" class="padding-left-right-0">
            ...
            <tbody>
               <tr class="project-overview">
                  ...
                  <td><?php echo new_html_entity_decode($proposals->proposal_name); ?></td>
               </tr>
               <tr class="project-overview">
               ...
               <tr class="project-overview">
                 ...
                 $current_id = $proposals->currency;
                 if($proposals->currency == 0){
               ...
               <tr class="project-overview">
                  ...
                  <td><?php echo new_html_entity_decode($proposals->reason_recruitment); ?></td>
               </tr>
    	...
    	<div class="col-md-6 padding-left-right-0">
            ...
            <tbody>
               ...
               <tr class="project-overview">
                  ...
                  <td><?php echo new_html_entity_decode($proposals->amount_recruiment); ?></td>
               </tr>
               <tr class="project-overview">
                  <td class="bold"><?php echo _l('workplace'); ?></td>
                  <td><?php echo new_html_entity_decode($proposals->workplace); ?></td>
               </tr>
    	...
    	<div class="col-md-6 padding-left-right-0">
            ...
            <tbody>
               ...
               <tr class="project-overview">
                  ...
                  <td><?php echo new_html_entity_decode($proposals->height); ?></td>
               </tr>
               <tr class="project-overview">
    	...
    	<div class="col-md-6 padding-left-right-0">
            ...
            <tbody>
               <tr class="project-overview">
                  ...
                  <td><?php echo new_html_entity_decode($proposals->ages_from.' - '.$proposals->ages_to); ?></td>
               </tr>
               <tr class="project-overview">
                  <td class="bold"><?php echo _l('weight'); ?></td>
                  <td><?php echo new_html_entity_decode($proposals->weight); ?></td>
               </tr>
               <tr class="project-overview">
      ...
      <div class="col-md-12">
         <div id="p_custom_fields_items">
            <?php echo render_custom_fields('plan', $proposals->id); ?>
        </div>
      </div>
