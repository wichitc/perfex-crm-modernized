      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <table class="table border table-striped margin-top-0">
                <tbody>
                  <tr class="project-overview">
                      ...
                      <td><?php echo new_html_entity_decode($recruitment_channel->r_form_name); ?></td>
                   </tr>
                   <tr class="project-overview">
                      <td class="bold" width="40%"><?php echo _l('total_cv_reciver'); ?></td>
                      <td><?php echo new_html_entity_decode($total_cv_form); ?></td>
                   </tr>
          ...
          <div class="row">
            ...
            <h4 class="bold"><?php echo _l('rec_Form_Info'); ?></h4>
            <p class="p-overflow"><b><?php echo _l('rec_Form_url'); ?>:</b>
            ...
            <hr>
            <h4 class="bold"><?php echo _l('rec_Embed_form'); ?></h4>
            <p><?php echo _l('rec_Embed_form_detail'); ?>:</p>
