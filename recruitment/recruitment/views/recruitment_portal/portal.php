...
<?php hooks()->do_action('app_customers_portal_head');?>
                                ...
                                <?php echo form_open_multipart(site_url('recruitment/recruitment_portal/search_job'), array('id' => 'search_job')); ?>
                                        ...
                                        <div class="form-group has-feedback has-feedback-left">
                                            <div class="input-group">
                                                <input type="search" name="search" placeholder="<?php echo _l('rp_key_search') ?>" class="form-control kb-search-input" value="<?php if (isset($search)) {echo new_html_entity_decode($search);}?>">
    ...
    <?php if (isset($rec_campaingn_total)) {?>
        <h2 class="title title-search text-danger"><a class="text-danger" href="#"><?php echo new_html_entity_decode($rec_campaingn_total) . ' ' . $search . _l('job_for_you') ?> </a></h2>
    <?php }?>
                              ...
                              <div class="row">
                                  <div class="job_content col-md-12">
                                    ...
                                    <div class="job-company-logo col-md-2 <?php if (!isset($rec_value['company_id']) || ($rec_value['company_id'] == '0')) {echo 'hide';}?>">
                                        <img class="images_w_table" src="<?php echo new_html_entity_decode(site_url($rec_value['company_logo'])) ?>" alt="<?php echo new_html_entity_decode($rec_value['alt_logo']) ?>">
                                    </div>
                                    ...
                                    <div class="job__description col-md-7 <?php if (!isset($rec_value['company_id']) || ($rec_value['company_id'] == '0')) {echo 'job__description_margin';}?>">
                                        <div class="job__body">
                                            <div class="details">
                                                <h2 class="title "><a class="bold a-color" data-controller="utm-tracking" href="<?php echo site_url('recruitment/recruitment_portal/job_detail/' . $rec_value['cp_id']) ?>"><?php echo new_html_entity_decode($rec_value['campaign_name']) ?></a>
                                                </h2>
                                    ...
                                    <div class="city_and_posted_date col-md-3">
                                        ...
                                        <div class="distance-time-job-posted">
                                            ...
                                            <?php echo new_html_entity_decode($rec_value['cp_from_date']); ?>
                                            </span> -
                                            <span class="distance-time highlight">
                                            <?php echo new_html_entity_decode($rec_value['cp_to_date']); ?>
                                            </span>
                                        </div>
                                    </div>
