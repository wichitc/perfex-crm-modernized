   ...
   <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2">
      ...
      <div class="panel_s">
         <div class="panel-body">
            ...
            <div class="form-group">
               <button type="submit" class="btn btn-info btn-block"><?php echo _l('candidates_login_login_string'); ?></button>
              <a href="<?php echo site_url('recruitment/authentication_candidate/register'); ?>" class="btn btn-success btn-block"><?php echo _l('candidates_register_string'); ?></a>
           </div>
           <div class="form-group">
