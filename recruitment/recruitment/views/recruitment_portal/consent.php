    ...
    <div class="panel-body">
        <div class="col-md-12">
            <?php if(is_client_logged_in()){ ?>
                <a href="<?php echo site_url('recruitment/recruitment_portal/gdpr'); ?>" class="btn btn-default pull-right">
        ...
        foreach($purposes as $purpose) {
           ...
           <div class="col-md-12">
            <div class="gdpr-purpose">
                <div class="row">
                    <div class="col-md-9">
                        <h3 class="gdpr-purpose-heading"><?php echo new_html_entity_decode($purpose['name']); ?>
                    ...
                    <div class="col-md-12">
                     ...
                     <p class="no-mbot mtop10">
                        <?php echo new_html_entity_decode($purpose['opt_in_purpose_description']); ?>
                    </p>
                    <?php } else if(!empty($purpose['description']) && empty($purpose['consent_given'])) { ?>
                    <p class="no-mbot mtop10">
                        <?php echo new_html_entity_decode($purpose['description']); ?>
                    </p>
                    <?php } ?>
                    <hr />
                    <div class="mtop15">
                        ...
                        <div class="radio radio-inline">
                            <input type="radio" value="opt-in" id="opt_in_<?php echo new_html_entity_decode($purpose['id']); ?>" name="action[<?php echo new_html_entity_decode($purpose['id']); ?>]">
                            <label for="opt_in_<?php echo new_html_entity_decode($purpose['id']); ?>"><?php echo _l('gdpr_consent_agree'); ?></label>
                        </div>
                        <?php if(empty($purpose['last_action_is_opt_out'])) { ?>
                        <div class="radio radio-inline">
                            <input type="radio" value="opt-out" id="opt_out_<?php echo new_html_entity_decode($purpose['id']); ?>" name="action[<?php echo new_html_entity_decode($purpose['id']); ?>]">
                            <label for="opt_out_<?php echo new_html_entity_decode($purpose['id']); ?>"><?php echo _l('gdpr_consent_disagree'); ?></label>
                        </div>
                        <?php } ?>
                        <?php } else { ?>
                        <div class="radio radio-inline">
