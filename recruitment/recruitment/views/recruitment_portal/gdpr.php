   ...
   <div class="panel-body">
      ...
      <div class="col-md-4">
         <div class="gdpr-right">
            ...
            <a href="<?php echo site_url('recruitment/recruitment_portal/tem_and_conditions'); ?>" class="btn btn-info"><?php echo _l('terms_and_conditions'); ?></a>
         </div>
      </div>
      <?php } ?>
      <div class="col-md-4">
         <div class="gdpr-right">
            ...
            <a href="<?php echo site_url('recruitment/recruitment_portal/profile'); ?>" class="btn btn-info"><?php echo _l('edit_my_information'); ?></a>
         </div>
      </div>
      ...
      <div class="col-md-4">
         <div class="gdpr-right">
            ...
            <a href="<?php echo candidate_consent_url(get_candidate_id()); ?>" class="btn btn-info"><?php echo _l('gdpr_consent'); ?></a>
         </div>
      </div>
      <?php } ?>
   </div>
