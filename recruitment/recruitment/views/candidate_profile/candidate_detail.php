        ...
        <div class="panel_s">
           <div class="panel-body">
           	...
           	<div class="col-md-12">
           		...
           		$current_id = $candidate->currency;
           		if ($candidate->currency == 0) {
				...
				<div class="col-md-4 ">
					<div class="form-group">
						...
						<select name="change_status" id="change_status" onchange="change_status_candidate(this,<?php echo new_html_entity_decode($candidate->id); ?>); return false;" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('change_status_to'); ?>">
							<option value=""></option>
				...
				<div class="col-md-3">
					...
					<a href="<?php echo new_html_entity_decode(admin_url('recruitment/candidates/' . $candidate->id )); ?>" class="btn btn-default pull-right mleft5 mbot15" ><i class="fa fa-edit"></i><?php echo ' ' . _l('edit'); ?></a>

						<a href="Javascript:void(0);" id="toggle_popup_approval" class="btn btn-success display-block pull-right mbot15"><i class="fa fa-user-md"></i><?php echo ' ' . _l('rec_care') . ' '; ?><i class="fa fa-caret-down"></i></a>
						<ul id="popup_approval" class="dropdown-menu dropdown-menu-right min-width-440">
							...
							<div class="form-group">
								...
								<a href="#" class="btn btn-warning pull-right mright5 mbot15" onclick="open_rating_dialog(); return false;"><i class="fa fa-star"></i><?php echo ' ' . _l('rate_candidate'); ?></a>
							</div>
						</div>
           	...
           	<div class="col-md-12">
		       	<div class="horizontal-scrollable-tabs preview-tabs-top">
		             ...
		             <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
		               <li role="presentation" <?php if($tab == 'detail'){echo " class='active'"; } ?>>
		                ...
		                <li role="presentation" <?php if($tab == 'applied_job'){echo " class='active'"; } ?>>
		                   <a href="<?php echo admin_url('recruitment/candidate/'.$candidate->id.'?tab=applied_job'); ?>" >
		                   <span class="fa fa-adjust"></span>&nbsp;<?php echo _l('re_applied_jobs'); ?>
		                   </a>
		                </li>
		                <li role="presentation" <?php if($tab == 'history_recruitment'){echo " class='active'"; } ?>>
		                   <a href="<?php echo admin_url('recruitment/candidate/'.$candidate->id.'?tab=history_recruitment'); ?>" >
		                   <i class="fa fa-calendar"></i>&nbsp;<?php echo _l('history_recruitment'); ?>
		                   </a>
		                </li>
		                <li role="presentation" <?php if($tab == 'capacity_profile'){echo " class='active'"; } ?>>
		                ...
		                <li role="presentation" <?php if($tab == 'attachment'){echo " class='active'"; } ?>>
		        ...
		        <div class="tab-content">
                  <div role="tabpanel" class="tab-pane <?php if($tab == 'detail'){echo "active"; } ?>" id="detail">
                  		...
                  		<table class="table border table-striped margin-top-0">
				            <tbody>
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($candidate->candidate_name . ' ' . $candidate->last_name); ?></td>
				               </tr>
				               <tr class="project-overview">
				               ...
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($candidate->nation); ?></td>
				               </tr>
				               ...
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($candidate->height); ?></td>
				               </tr>
                  		...
                  		<table class="table border table-striped margin-top-0">
				            <tbody>
				            	<tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($candidate->candidate_code); ?></td>
				               </tr>
				               <tr class="project-overview">
				               ...
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($candidate->nationality); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('religion'); ?></td>
				                  <td><?php echo new_html_entity_decode($candidate->religion); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('weight'); ?></td>
				                  <td><?php echo new_html_entity_decode($candidate->weight); ?></td>
				               </tr>
                  		...
                  		<table class="table border table-striped margin-top-0">
				            <tbody>
				               ...
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($candidate->identification); ?></td>
				               </tr>
				               ...
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($candidate->resident); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('phonenumber'); ?></td>
				                  <td><?php echo new_html_entity_decode($candidate->phonenumber); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('alternate_contact_number'); ?></td>
				                  <td><?php echo new_html_entity_decode($candidate->alternate_contact_number); ?></td>
				               </tr>

				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('skype'); ?></td>
				                  <td><a href="<?php echo new_html_entity_decode($candidate->skype); ?>"><?php echo new_html_entity_decode($candidate->skype); ?></a></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('skill_name'); ?></td>
				                  <td><?php echo new_html_entity_decode($skill_name); ?></td>
				               </tr>

				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('introduce_yourself'); ?></td>
				                  <td><?php echo new_html_entity_decode($candidate->introduce_yourself); ?></td>
				               </tr>
				            </tbody>
				        </table>
                  	</div>
                  		...
                  		<table class="table border table-striped margin-top-0">
				            <tbody>
				               ...
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($candidate->home_town); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('current_accommodation'); ?></td>
				                  <td><?php echo new_html_entity_decode($candidate->current_accommodation); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('email'); ?></td>
				                  <td><a href="mailto:<?php echo new_html_entity_decode($candidate->email); ?>"><?php echo new_html_entity_decode($candidate->email); ?></a></td>

				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('facebook'); ?></td>
				                  <td><a href="<?php echo new_html_entity_decode($candidate->facebook); ?>"><?php echo new_html_entity_decode($candidate->facebook); ?></a></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('linkedin'); ?></td>
				                  <td><a href="<?php echo new_html_entity_decode($candidate->linkedin); ?>"><?php echo new_html_entity_decode($candidate->linkedin); ?></a></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('experience'); ?></td>
				                  <td><?php echo new_html_entity_decode(_l($candidate->year_experience ?? '')); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('interests'); ?></td>
				                  <td><?php echo new_html_entity_decode($candidate->interests); ?></td>
				               </tr>
                  	...
                  	<div class="col-md-12">
                  		<div id="p_custom_fields_items">
                  			<?php echo render_custom_fields('candidate', $candidate->id); ?>
                  		</div>
                  	</div>
              			...
              			<table class="table dt-table margin-top-0">
				            ...
				            <?php foreach ($candidate->work_experience as $we) {?>
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($we['company']); ?></td>
				                  <td><?php echo new_html_entity_decode($we['position']); ?></td>
				                  <td><?php echo new_html_entity_decode($we['contact_person']); ?></td>
				                  <td><?php echo new_html_entity_decode(app_format_money((float)$we['salary'], $current_id)); ?></td>
				                  <td><?php echo new_html_entity_decode($we['reason_quitwork']); ?></td>
				                  <td><?php echo new_html_entity_decode($we['job_description']); ?></td>
				               </tr>
				           <?php }?>
				            </tbody>
				        </table>
              			...
              			<table class="table dt-table margin-top-0">
				            ...
				            <?php foreach ($candidate->literacy as $we) {?>
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode(_l($we['diploma'])); ?></td>
				                  <td><?php echo new_html_entity_decode($we['training_places']); ?></td>
				                  <td><?php echo new_html_entity_decode($we['specialized']); ?></td>
				                  <td><?php echo new_html_entity_decode($we['training_form']); ?></td>
              		...
              		<?php if (count($candidate->family_infor) > 0) {?>
              			<table class="table dt-table margin-top-0">
				            ...
				            <?php foreach ($candidate->family_infor as $we) {?>
				               <tr class="project-overview">
				                  <td><?php echo new_html_entity_decode($we['relationship']); ?></td>
				                  <td><?php echo new_html_entity_decode($we['name']); ?></td>
				                  <td><?php echo _d($we['fi_birthday']); ?></td>
				                  <td><?php echo new_html_entity_decode($we['job']); ?></td>
				                  <td><?php echo new_html_entity_decode($we['address']); ?></td>
				                  <td><?php echo new_html_entity_decode($we['phone']); ?></td>
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($tab == 'applied_job'){echo "active"; } ?>" id="applied_job">
                  	<table class="table dt-table margin-top-0 table-applied_job">
                  		<thead>
                  			<th><?php echo _l('campaign'); ?></th>
                  			<th><?php echo _l('date_applied'); ?></th>
                  				...
                  				<td>
                  				 ...
                  				 <td>
                  				 	<?php if($applied_job['activate'] == '0'){ ?>
                  				 		<?php echo _l('rec_candidate_has_abandoned_apply_for_this_position'); ?>
                  				 	<?php }else{ ?>
                  				 	<?php } ?>
                  				 </td>
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($tab == 'history_recruitment'){echo "active"; } ?>" id="history_recruitment">
	...
	?>
              			<table class="table dt-table margin-top-0">
				            ...
				            <tbody>
				            	...
				            	<tr class="project-overview">
				            		<td><?php
				            		$campaign_currency = $get_base_currency->id;
				            		$cp = get_rec_campaign_hp($candidate->rec_campaign);
				            		$datas = '';
				            		if (isset($cp)) {
				            			$datas = '<a href="' . admin_url('recruitment/recruitment_campaign/' . $cp->cp_id) . '">' . $cp->campaign_code . ' - ' . $cp->campaign_name . '</a>';
				            	...
				            	?></td>
				                  <td><?php echo get_status_candidate($candidate->status); ?></td>
				                  <td><?php echo _d($candidate->date_add); ?></td>
				                  <td><?php echo app_format_money($candidate->desired_salary, $campaign_currency); ?></td>
				               </tr>
				            </tbody>
				        </table>
              		<?php } else {?>
...
$_data = '<a href="' . admin_url('staff/profile/' . $care['add_from']) . '">' . staff_profile_image($care['add_from'], [
		...
		?>
				                  ...
				                  <td><?php echo new_html_entity_decode($care['care_result']); ?></td>
				                  <td><?php echo new_html_entity_decode($care['description']); ?></td>
				               </tr>
				     		<?php }?>
				            </tbody>
				        </table>
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($tab == 'capacity_profile'){echo "active"; } ?>" id="capacity_profile">
...
$_data = '<a href="' . admin_url('staff/profile/' . $assessor) . '">' . staff_profile_image($assessor, [
	...
	?></td>
				               ...
				               <tr class="project-overview">
				                  ...
				                  <td><?php echo new_html_entity_decode($avg_score); ?></td>
				               </tr>
				               <tr class="project-overview">
				                  <td class="bold"><?php echo _l('feedback'); ?></td>
				                  <td><?php echo new_html_entity_decode($feedback); ?></td>
				               </tr>
	...
	foreach ($data_group as $key => $gr) {
		?>
				           			<tr>
				           				<td class="bold text-danger"><?php echo new_html_entity_decode($count_gr . '. ' . get_criteria_name($key)); ?></td>
				           				<td class="bold text-danger"><?php echo new_html_entity_decode($gr['toltal_percent'] . '%'); ?></td>
				           				<td class="bold text-danger"></td>
				           				<td class="bold text-danger"><?php echo new_html_entity_decode($gr['result']); ?></td>
				           			</tr>
				           			<?php $count_cr = 1;foreach ($cd_evaluation as $cd) {
			if ($cd['group_criteria'] == $key) {
				?>
				           				<tr>
					           				<td><?php echo new_html_entity_decode($count_gr . '.' . $count_cr . '. ' . get_criteria_name($cd['criteria'])); ?></td>
					           				<td><?php echo new_html_entity_decode($cd['percent'] . '%'); ?></td>
					           				<td>
					           					<?php
$sp1 = '';
				$sp2 = '';
				...
				?>
												<span class="fa fa-star<?php echo new_html_entity_decode($sp1); ?>"></span>
												<span class="fa fa-star<?php echo new_html_entity_decode($sp2); ?>"></span>
												<span class="fa fa-star<?php echo new_html_entity_decode($sp3); ?>"></span>
												<span class="fa fa-star<?php echo new_html_entity_decode($sp4); ?>"></span>
												<span class="fa fa-star<?php echo new_html_entity_decode($sp5); ?>"></span>
					           				</td>
					           				<td><?php echo new_html_entity_decode(($cd['rate_score'] * $cd['percent']) / 100); ?></td>
				           				</tr>
				           			<?php $count_cr++;}}?>
				           		<?php $count_gr++;}}?>
				            </tbody>
...
<div class="modal fade" id="candidate_rating" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	...
	foreach ($evaluation['groups'] as $gr) {
		...
		?>
                  			...
                  			<h5 class="bold"><?php echo new_html_entity_decode($count_gr . '. ' . $gr['criteria_title']); ?></h5>
			...
			if ($cr['group_cr'] == $gr['id']) {
				...
				?>
                  			...
                  			<p><div class="star-rating">
                  				&nbsp;&nbsp;&nbsp;<?php echo new_html_entity_decode($count_gr . '.' . $count_cr . '. ' . $cr['criteria_title'] . ' (' . $cr['percent'] . '%)'); ?>
                  				<div class="pull-right font-size-125">
			                    <span class="fa-regular fa-star margin-top-8" data-rating="1" data-id="<?php echo new_html_entity_decode($cr['evaluation_criteria']); ?>"></span>
			                    <span class="fa-regular fa-star margin-top-8" data-rating="2" data-id="<?php echo new_html_entity_decode($cr['evaluation_criteria']); ?>"></span>
			                    <span class="fa-regular fa-star margin-top-8" data-rating="3" data-id="<?php echo new_html_entity_decode($cr['evaluation_criteria']); ?>"></span>
			                    <span class="fa-regular fa-star margin-top-8" data-rating="4" data-id="<?php echo new_html_entity_decode($cr['evaluation_criteria']); ?>"></span>
			                    <span class="fa-regular fa-star margin-top-8" data-rating="5" data-id="<?php echo new_html_entity_decode($cr['evaluation_criteria']); ?>"></span>
			                    <input type="hidden" name="rating[<?php echo new_html_entity_decode($cr['evaluation_criteria']); ?>]" class="rating-value" value="">
			                    <input type="hidden" name="percent[<?php echo new_html_entity_decode($cr['evaluation_criteria']); ?>]" value="<?php echo new_html_entity_decode($cr['percent']); ?>">
			                    <input type="hidden" name="group[<?php echo new_html_entity_decode($cr['evaluation_criteria']); ?>]" value="<?php echo new_html_entity_decode($gr['id']); ?>">
			                	</div>
