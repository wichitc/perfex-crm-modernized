...
echo render_date_input('birthday', 'birthday', $birthday)?>
                        ...
                        <div class="col-md-2">
                            ...
                            foreach ($currencies as $currency) {
                                ...
                                if (isset($candidate)) {
                                    if ($currency['id'] == $candidate->currency) {
...
;
                            ...
                            <?php echo render_select('currency', $currencies, ['id', 'name', 'symbol'], 'invoice_add_edit_currency', $selected, $currency_attr, [],  '', '', false); ?>
                        </div>
...
echo render_textarea('introduce_yourself', 'introduce_yourself', $introduce_yourself, $rows)?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                            <label for="year_experience" class="control-label"><?php echo _l('experience'); ?></label> 
                        ...
                        <div class="col-md-12">
                            <div id="custom_fields_items">
                                <?php echo render_custom_fields('candidate', isset($candidate) ? $candidate->id : ''); ?>
                            </div>
                        </div>
...
echo render_textarea('current_accommodation', 'current_accommodation', $current_accommodation)?>
                        ...
                        <div class="col-md-12">
                            <label><?php echo _l('staff_add_edit_password'); ?></label>
                            ...
                            <?php if(isset($candidate) && $candidate->last_password_change != NULL){ ?>
                                <?php echo _l('staff_add_edit_password_last_changed'); ?>:
                                <span class="text-has-action" data-toggle="tooltip" data-title="<?php echo _dt($candidate->last_password_change); ?>">
                                    <?php echo time_ago($candidate->last_password_change); ?>
                                </span>
                            <?php }  ?>
                        </div>
                      </div>
		...
		?>
                          <div class="row col-md-12" id="work_experience-item">
                            ...
                            if($val['from_date'] != '0000-00-00'){
                                $from_date = _d($val['from_date']);
                            }else{
                                $from_date = _d(date('Y-m-d'));
                            }
