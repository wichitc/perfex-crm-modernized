...
<table class="table dt-table">
 ...
 <tbody>
    ...
    <tr>
       <td><?php echo new_html_entity_decode($company['company_name']); ?></td>
       <td><?php echo new_html_entity_decode($company['company_address']); ?></td>
       <td><?php echo new_html_entity_decode($company['company_industry']); ?></td>
       <td>
         <a href="#" onclick="edit_company(this,<?php echo new_html_entity_decode($company['id']); ?>); return false" data-name="<?php echo new_html_entity_decode($company['company_name']); ?>" data-address="<?php echo new_html_entity_decode($company['company_address']); ?>" data-industry="<?php echo new_html_entity_decode($company['company_industry']); ?>" class="btn btn-default btn-icon"><i class="fa-regular fa-pen-to-square"></i></a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          ...
                          <div id="dropzoneDragArea" class="dz-default dz-message">
                             <span><?php echo _l('rec_drag_drop_file_here'); ?></span>
                          </div>
