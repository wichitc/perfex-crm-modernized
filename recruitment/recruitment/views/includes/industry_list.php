...
<table class="table dt-table">
 ...
 <tbody>
    ...
    <tr>
       <td><?php echo new_html_entity_decode($industry['industry_name']); ?></td>
       <td>
         <a href="#" onclick="edit_industry(this,<?php echo new_html_entity_decode($industry['id']); ?>); return false" data-name="<?php echo new_html_entity_decode($industry['industry_name']); ?>" class="btn btn-default btn-icon"><i class="fa-regular fa-pen-to-square"></i></a>
