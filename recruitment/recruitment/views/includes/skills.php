...
<table class="table dt-table">
 ...
 <tbody>
    ...
    <tr>
       <td><?php echo new_html_entity_decode($skill['id']); ?></td>
       <td><?php echo new_html_entity_decode($skill['skill_name']); ?></td>
       <td>
         <a href="#" onclick="edit_skill(this,<?php echo new_html_entity_decode($skill['id']); ?>); return false" data-name="<?php echo new_html_entity_decode($skill['skill_name']); ?>" class="btn btn-default btn-icon"><i class="fa-regular fa-pen-to-square"></i></a>
