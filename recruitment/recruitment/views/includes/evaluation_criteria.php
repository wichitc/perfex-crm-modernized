...
<table class="table dt-table">
 ...
 <tbody>
	...
	?>
        ...
        <?php if($gr['criteria_type'] == 'criteria'){ ?>
            <td><?php echo _l('evaluation_'.$gr['criteria_type']); ?></td>
        ...
        <td>
            ...
            <a href="#" onclick="edit_evaluation_criteria(this,<?php echo new_html_entity_decode($gr['criteria_id']); ?>); return false;" data-criteria_title="<?php echo new_html_entity_decode($gr['criteria_title']); ?>" data-criteria_type="<?php echo new_html_entity_decode($gr['criteria_type']); ?>" data-description="<?php echo new_html_entity_decode($gr['description']); ?>" data-group_criteria="<?php echo new_html_entity_decode($gr['group_criteria']); ?>" data-score_des1="<?php echo new_html_entity_decode($gr['score_des1']); ?>" data-score_des2="<?php echo new_html_entity_decode($gr['score_des2']); ?>" data-score_des3="<?php echo new_html_entity_decode($gr['score_des3']); ?>" data-score_des4="<?php echo new_html_entity_decode($gr['score_des4']); ?>" data-score_des5="<?php echo new_html_entity_decode($gr['score_des5']); ?>" class="btn btn-default btn-icon"><i class="fa-regular fa-pen-to-square"></i>
            </a>
            <?php }?>
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="form">
                        ...
                        <select name="criteria_type" id="criteria_type" onchange="criteria_type_change(this); return false;" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" required>
                          <option value=""></option>
                          <option value="criteria"><?php echo _l('evaluation_criteria'); ?></option>
                        ...
                        <div id="select_group_criteria">
                            ...
                            <select name="group_criteria" id="group_criteria" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" required>
                              ...
                              <?php foreach ($list_group as $gr) {?>
                                <option value="<?php echo new_html_entity_decode($gr['criteria_id']); ?>"><?php echo new_html_entity_decode($gr['criteria_title']); ?></option>
                              <?php }?>
                            </select>
                            <br><br>
                        </div>
