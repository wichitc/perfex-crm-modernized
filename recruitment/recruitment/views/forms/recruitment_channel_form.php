...
<body class="web-to-lead <?php echo new_html_entity_decode($form->form_key); ?>"<?php if(is_rtl(true)){ echo ' dir="rtl"';} ?>>
  <div class="container">
    <div class="row">
      <div class="<?php if($this->input->get('col')){echo new_html_entity_decode($this->input->get('col'));} else {echo 'col-md-12';} ?>">
        <div id="response"></div>
        ...
        <?php } ?>
         ...
         <div class="text-left col-md-12 submit-btn-wrapper">
          <?php if(is_numeric($rec_campaignid) && $rec_campaignid != 0){ ?>
            <a href="<?php echo site_url('recruitment/recruitment_portal/job_detail/'.$rec_campaignid); ?>" class="btn btn-default"><?php echo _l('cancel'); ?></a>
          <?php } ?>
          <button class="btn btn-success" id="form_submit" type="submit"><?php echo new_html_entity_decode($form->submit_btn_name); ?></button>
        </div>
      </div>
