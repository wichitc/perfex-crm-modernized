...
function new_campaign(){
  "use strict"; 
  $('#recruitment_campaign').modal({show: true,backdrop: 'static'});
  ...
  /*get custom_fields_html*/
  $.post(admin_url + 'recruitment/get_recruitment_campaign_add').done(function(response) {
...
function edit_campaign(invoker,id){
  ...
  /*get job_description*/
    $.post(admin_url + 'recruitment/get_recruitment_campaign_edit/'+id).done(function(response) {
        response = JSON.parse(response);
        $('#recruitment_campaign input[name="job_meta_title"]').val(response.job_meta_title);
        $('#recruitment_campaign textarea[name="job_meta_description"]').val(response.job_meta_description);
  ...
  $('#recruitment_campaign select[name="cp_experience"]').change();
  $('#recruitment_campaign select[name="currency"]').val($(invoker).data('currency'));
  $('#recruitment_campaign select[name="currency"]').change();
