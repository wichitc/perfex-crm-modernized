<script>
   ...
   (function($) {
    ...
    "use strict";
      ...
      {
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/recruitment/uploads/file_samples/sample_import_cadidates_file.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );
      }else{
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/recruitment/uploads/file_samples/sample_import_cadidates_file.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );
      }
...
function uploadfilecsv(event){
  "use strict";
    ...
    if(<?php echo  rec_check_csrf_protection(); ?>){
    ...
    $.ajax({ 
      url: admin_url + 'recruitment/import_file_xlsx_candidate', 
      method: 'post', 
      data: formData, 
      contentType: false, 
      processData: false
