...
"use strict";
    ...
    var ProposalServerParams = {
        ...
        "skill_filter": "[name='skill_filter[]']",
        "job_title_filter": "[name='job_title_filter[]']",
        "experience_filter": "[name='experience_filter[]']",
        "age_group_filter": "[name='age_group_filter']",
        "birthday_filter": "[name='birthday_filter']",
        "gender_filter": "[name='gender_filter[]']",
        "marital_status_filter": "[name='marital_status_filter[]']",
    ...
    $('input[name="birthday_filter"]').on('change', function() {  
        table_rec_candidate.DataTable().ajax.reload();
    });
...
/*print barcode*/
  function print_candidate_bulk_actions(){
    ...
    $('#table_commodity_list_print_candidate').modal({show: true,backdrop: 'static'});
  }
